...
<body>
    ...
    <div class="container">
        <div class="col-md-2" align="center">
            <img src="res/images/lnmiit logo.png" style="height: 20vh" alt="LNMIIT logo">
        </div>
        <div class="row col-md-8 col-sm-12" align="center">
            <h3 style="margin-top: 7vh;color: #1F618D;font-weight: bold">THE LNM INSTITUTE OF INFORMATION TECHNOLOGY</h3>
            <h5 style="color: #F24331"><b>"EXCELLENCE OUR MOTTO DISCIPLINE OUR WAY"</b></h5>
        </div>
