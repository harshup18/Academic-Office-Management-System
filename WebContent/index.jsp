    ...
    <div class="container">    
        <div id="loginbox" style="margin-top:10vh;" class="mainbox col-md-4 col-md-offset-4 col-sm-8 col-sm-offset-2">                    
                        ...
                        <form id="loginForm" class="form-horizontal" role="form" action="LoginServlet" method="post">
                            ...
                            <div style="color: #17202A;font-family: verdana;font-size: 21px"><p align="left">Sign In</p></div>
                            <div style="border-bottom: 1px solid #D5D8DC;padding-top: 5px;"></div>
                                    
                            <div style="color: #17202A;font-size: 13px;padding-top: 15px"><p>Username</p></div>
                            ...
                            <div style="margin-bottom: 25px" class="input-group">
                                        ...
                                        <input id="login-username" type="text" class="form-control" name="username" placeholder="Enter Username" style="height: 6vh">                                        
                                    </div>

                            <div style="color: #17202A;font-size: 13px"><p>Password</p></div>
                                
                            <div style="margin-bottom: 25px" class="input-group">
                                        <span class="input-group-addon" style="background-color: #FBFCFC"><i class="glyphicon glyphicon-lock" style="color: #17202A"></i></span>
                                        <input id="login-password" type="password" class="form-control" name="password" placeholder="Enter Password" style="height: 6vh">
                                    </div>
                                ...
                                <div style="margin-top:10px" class="form-group">
                                    ...
                                    <div class="col-sm-12 controls">
                                      <button id="btn-login" class="btn" style="background-color: #17202A;width: 100%;height: 6vh;color: #FBFCFC" type="submit">Log in to your account</button>
                                    </div>
                                </div>
